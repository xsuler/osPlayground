...
00000060 <fmtname>:
{
  ...
  return buf;
  cb:	bb 38 0e 00 00       	mov    $0xe38,%ebx
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
...
00000110 <ls>:
{
 ...
 1a5:	6a 02                	push   $0x2
 1a7:	50                   	push   %eax
 1a8:	68 e0 0a 00 00       	push   $0xae0
 1ad:	6a 01                	push   $0x1
 1af:	e8 9c 05 00 00       	call   750 <printf>
    break;
 ...
 2b1:	50                   	push   %eax
 2b2:	68 e0 0a 00 00       	push   $0xae0
 2b7:	6a 01                	push   $0x1
 2b9:	e8 92 04 00 00       	call   750 <printf>
 ...
 2f3:	68 ed 0a 00 00       	push   $0xaed
 2f8:	6a 01                	push   $0x1
 2fa:	e8 51 04 00 00       	call   750 <printf>
      break;
 ...
 313:	57                   	push   %edi
 314:	68 cc 0a 00 00       	push   $0xacc
 319:	6a 02                	push   $0x2
 31b:	e8 30 04 00 00       	call   750 <printf>
    close(fd);
 ...
 341:	6a 01                	push   $0x1
 343:	e8 08 04 00 00       	call   750 <printf>
        continue;
 ...
 696:	89 d3                	mov    %edx,%ebx
{
 ...
 69b:	89 45 bc             	mov    %eax,-0x44(%ebp)
  if(sgn && xx < 0){
 69e:	85 d2                	test   %edx,%edx
 6a0:	0f 89 92 00 00 00    	jns    738 <printint+0xa8>
 6a6:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
 6aa:	0f 84 88 00 00 00    	je     738 <printint+0xa8>
    neg = 1;
 6b0:	c7 45 c0 01 00 00 00 	movl   $0x1,-0x40(%ebp)
    x = -xx;
 6b7:	f7 db                	neg    %ebx
  } else {
    x = xx;
  ...
  i = 0;
 6b9:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
 6c0:	8d 75 d7             	lea    -0x29(%ebp),%esi
 6c3:	eb 08                	jmp    6cd <printint+0x3d>
 ...
 6d1:	8b 7d c4             	mov    -0x3c(%ebp),%edi
 6d4:	f7 f1                	div    %ecx
 6d6:	83 c7 01             	add    $0x1,%edi
 6d9:	0f b6 92 0c 0b 00 00 	movzbl 0xb0c(%edx),%edx
 6e0:	88 14 3e             	mov    %dl,(%esi,%edi,1)
  }while((x /= base) != 0);
 6e3:	39 d9                	cmp    %ebx,%ecx
 6e5:	76 e1                	jbe    6c8 <printint+0x38>
  if(neg)
 6e7:	8b 45 c0             	mov    -0x40(%ebp),%eax
 6ea:	85 c0                	test   %eax,%eax
 6ec:	74 0d                	je     6fb <printint+0x6b>
    buf[i++] = '-';
 6ee:	c6 44 3d d8 2d       	movb   $0x2d,-0x28(%ebp,%edi,1)
 6f3:	ba 2d 00 00 00       	mov    $0x2d,%edx
    buf[i++] = digits[x % base];
 6f8:	89 7d c4             	mov    %edi,-0x3c(%ebp)
 6fb:	8b 45 c4             	mov    -0x3c(%ebp),%eax
 6fe:	8b 7d bc             	mov    -0x44(%ebp),%edi
 701:	8d 5c 05 d7          	lea    -0x29(%ebp,%eax,1),%ebx
 705:	eb 0f                	jmp    716 <printint+0x86>
 ...
 71e:	56                   	push   %esi
 71f:	57                   	push   %edi
 720:	e8 9c fe ff ff       	call   5c1 <write>

  while(--i >= 0)
 725:	83 c4 10             	add    $0x10,%esp
 728:	39 de                	cmp    %ebx,%esi
 72a:	75 e4                	jne    710 <printint+0x80>
    putc(fd, buf[i]);
}
 ...
 734:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  neg = 0;
 738:	c7 45 c0 00 00 00 00 	movl   $0x0,-0x40(%ebp)
 73f:	e9 75 ff ff ff       	jmp    6b9 <printint+0x29>
...
printf(int fd, char *fmt, ...)
{
 ...
 761:	0f 84 b9 00 00 00    	je     820 <printf+0xd0>
  ap = (uint*)(void*)&fmt + 1;
 ...
 799:	e8 23 fe ff ff       	call   5c1 <write>
 ...
 7a4:	83 c6 01             	add    $0x1,%esi
  for(i = 0; fmt[i]; i++){
 7a7:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
 7ab:	84 db                	test   %bl,%bl
 7ad:	74 71                	je     820 <printf+0xd0>
    c = fmt[i] & 0xff;
 7af:	0f be cb             	movsbl %bl,%ecx
 7b2:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
 7b5:	85 d2                	test   %edx,%edx
 7b7:	74 c7                	je     780 <printf+0x30>
      }
    } else if(state == '%'){
 7b9:	83 fa 25             	cmp    $0x25,%edx
 7bc:	75 e6                	jne    7a4 <printf+0x54>
      if(c == 'd'){
 7be:	83 f8 64             	cmp    $0x64,%eax
 7c1:	0f 84 99 00 00 00    	je     860 <printf+0x110>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
 7c7:	81 e1 f7 00 00 00    	and    $0xf7,%ecx
 7cd:	83 f9 70             	cmp    $0x70,%ecx
 7d0:	74 5e                	je     830 <printf+0xe0>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
 7d2:	83 f8 73             	cmp    $0x73,%eax
 7d5:	0f 84 d5 00 00 00    	je     8b0 <printf+0x160>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 7db:	83 f8 63             	cmp    $0x63,%eax
 7de:	0f 84 8c 00 00 00    	je     870 <printf+0x120>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
 7e4:	83 f8 25             	cmp    $0x25,%eax
 7e7:	0f 84 b3 00 00 00    	je     8a0 <printf+0x150>
  write(fd, &c, 1);
 7ed:	83 ec 04             	sub    $0x4,%esp
 7f0:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
 7f4:	6a 01                	push   $0x1
 7f6:	57                   	push   %edi
 ...
 80e:	e8 ae fd ff ff       	call   5c1 <write>
  for(i = 0; fmt[i]; i++){
 813:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
        putc(fd, c);
 ...
 842:	e8 49 fe ff ff       	call   690 <printint>
        ap++;
 ...
 881:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 884:	e8 38 fd ff ff       	call   5c1 <write>
        ap++;
 ...
 8a6:	e9 5a ff ff ff       	jmp    805 <printf+0xb5>
 8ab:	90                   	nop
 ...
 8fb:	57                   	push   %edi
 8fc:	53                   	push   %ebx
 8fd:	e8 bf fc ff ff       	call   5c1 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 921:	a1 48 0e 00 00       	mov    0xe48,%eax
{
 ...
 946:	73 10                	jae    958 <free+0x38>
{
 ...
 971:	5b                   	pop    %ebx
  freep = p;
 972:	a3 48 0e 00 00       	mov    %eax,0xe48
}
 977:	5e                   	pop    %esi
 978:	5f                   	pop    %edi
 979:	5d                   	pop    %ebp
 ...
 997:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 99a:	a3 48 0e 00 00       	mov    %eax,0xe48
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 9b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9bc:	8b 3d 48 0e 00 00    	mov    0xe48,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a09:	8b 3d 48 0e 00 00    	mov    0xe48,%edi
 ...
 a32:	e8 e9 fe ff ff       	call   920 <free>
  return freep;
 a37:	8b 15 48 0e 00 00    	mov    0xe48,%edx
      if((p = morecore(nunits)) == 0)
 a3d:	83 c4 10             	add    $0x10,%esp
 a40:	85 d2                	test   %edx,%edx
 a42:	75 bc                	jne    a00 <malloc+0x50>
        return 0;
  }
}
 ...
 a64:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a67:	89 15 48 0e 00 00    	mov    %edx,0xe48
}
 ...
 a79:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 a80:	c7 05 48 0e 00 00 4c 	movl   $0xe4c,0xe48
 a87:	0e 00 00 
    base.s.size = 0;
 a8a:	bf 4c 0e 00 00       	mov    $0xe4c,%edi
    base.s.ptr = freep = prevp = &base;
 a8f:	c7 05 4c 0e 00 00 4c 	movl   $0xe4c,0xe4c
 a96:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){

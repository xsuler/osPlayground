...
main(int argc, char *argv[])
{
  ...
  17:	68 98 07 00 00       	push   $0x798
  1c:	6a 01                	push   $0x1
  1e:	e8 0d 04 00 00       	call   430 <printf>
  exit();
  23:	e8 59 02 00 00       	call   281 <exit>
  28:	66 90                	xchg   %ax,%ax
  2a:	66 90                	xchg   %ax,%ax
  2c:	66 90                	xchg   %ax,%ax
  2e:	66 90                	xchg   %ax,%ax
...
printf(int fd, char *fmt, ...)
{
 ...
 5b4:	eb 1a                	jmp    5d0 <printf+0x1a0>
          s = "(null)";
 5b6:	bb 9b 07 00 00       	mov    $0x79b,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d 4c 0a 00 00    	mov    0xa4c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 712:	e8 e9 fe ff ff       	call   600 <free>
  return freep;
 717:	8b 15 4c 0a 00 00    	mov    0xa4c,%edx

...
main(int argc, char *argv[])
{
  ...
  if(argc<1)
  12:	8b 09                	mov    (%ecx),%ecx
  14:	85 c9                	test   %ecx,%ecx
  16:	7e 0e                	jle    26 <main+0x26>
    exit();
  if(argv[1][0]=='-')
  18:	8b 43 04             	mov    0x4(%ebx),%eax
  1b:	80 38 2d             	cmpb   $0x2d,(%eax)
  1e:	75 06                	jne    26 <main+0x26>
  {
    switch(argv[1][1])
  20:	80 78 01 72          	cmpb   $0x72,0x1(%eax)
  24:	74 05                	je     2b <main+0x2b>
        exec("scsh", argv);
      }
      break;
    }
  ...
  2e:	6a 00                	push   $0x0
  30:	e8 85 03 00 00       	call   3ba <split>
  pid = fork();
  35:	e8 c0 02 00 00       	call   2fa <fork>
  if(pid == -1)
  3a:	83 c4 10             	add    $0x10,%esp
  3d:	83 f8 ff             	cmp    $0xffffffff,%eax
  40:	74 20                	je     62 <main+0x62>
      if(fork1()==0)
  42:	85 c0                	test   %eax,%eax
  44:	75 e0                	jne    26 <main+0x26>
        split(-1);
  46:	83 ec 0c             	sub    $0xc,%esp
  49:	6a ff                	push   $0xffffffff
  4b:	e8 6a 03 00 00       	call   3ba <split>
        exec("scsh", argv);
  50:	58                   	pop    %eax
  51:	5a                   	pop    %edx
  52:	53                   	push   %ebx
  53:	68 d1 07 00 00       	push   $0x7d1
  58:	e8 dd 02 00 00       	call   33a <exec>
  5d:	83 c4 10             	add    $0x10,%esp
  60:	eb c4                	jmp    26 <main+0x26>
    panic("fork");
  62:	83 ec 0c             	sub    $0xc,%esp
  65:	68 cc 07 00 00       	push   $0x7cc
  6a:	e8 01 00 00 00       	call   70 <panic>
  6f:	90                   	nop
...
00000090 <fork1>:
{
  ...
  pid = fork();
  96:	e8 5f 02 00 00       	call   2fa <fork>
  if(pid == -1)
  9b:	83 f8 ff             	cmp    $0xffffffff,%eax
  9e:	74 02                	je     a2 <fork1+0x12>
}
  a0:	c9                   	leave  
  a1:	c3                   	ret    
    panic("fork");
  a2:	83 ec 0c             	sub    $0xc,%esp
  a5:	68 cc 07 00 00       	push   $0x7cc
  aa:	e8 c1 ff ff ff       	call   70 <panic>
  af:	90                   	nop
...
printf(int fd, char *fmt, ...)
{
 ...
 624:	e9 8f fe ff ff       	jmp    4b8 <printf+0x48>
          s = "(null)";
 629:	bb d6 07 00 00       	mov    $0x7d6,%ebx
        while(*s != 0){

...
_resetclk:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  if(argc<1)
   ...
   b:	7e 05                	jle    12 <main+0x12>
    exit();
  resettm();
   d:	e8 37 03 00 00       	call   349 <resettm>
  exit();
  12:	e8 5a 02 00 00       	call   271 <exit>
  17:	66 90                	xchg   %ax,%ax
  19:	66 90                	xchg   %ax,%ax
  1b:	66 90                	xchg   %ax,%ax
  1d:	66 90                	xchg   %ax,%ax
...
00000331 <memo>:
SYSCALL(memo)
 331:	b8 1a 00 00 00       	mov    $0x1a,%eax
 336:	cd 40                	int    $0x40
 338:	c3                   	ret    

00000339 <getmemo>:
SYSCALL(getmemo)
 339:	b8 1b 00 00 00       	mov    $0x1b,%eax
 33e:	cd 40                	int    $0x40
 340:	c3                   	ret    

00000341 <setmemo>:
SYSCALL(setmemo)
 341:	b8 1c 00 00 00       	mov    $0x1c,%eax
 346:	cd 40                	int    $0x40
 348:	c3                   	ret    

00000349 <resettm>:
SYSCALL(resettm)
 349:	b8 1d 00 00 00       	mov    $0x1d,%eax
 34e:	cd 40                	int    $0x40
 350:	c3                   	ret    
 ...
 366:	89 d3                	mov    %edx,%ebx
{
 ...
 3ee:	56                   	push   %esi
 3ef:	57                   	push   %edi
 3f0:	e8 9c fe ff ff       	call   291 <write>
...
printf(int fd, char *fmt, ...)
{
 ...
 469:	e8 23 fe ff ff       	call   291 <write>
 ...
 4ca:	e8 c2 fd ff ff       	call   291 <write>
        putc(fd, c);
      } else {
 ...
 4de:	e8 ae fd ff ff       	call   291 <write>
  for(i = 0; fmt[i]; i++){
 ...
 551:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 554:	e8 38 fd ff ff       	call   291 <write>
        ap++;
 ...
 5cb:	57                   	push   %edi
 5cc:	53                   	push   %ebx
 5cd:	e8 bf fc ff ff       	call   291 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f1:	a1 30 0a 00 00       	mov    0xa30,%eax
{
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 3d 30 0a 00 00    	mov    0xa30,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6eb:	e8 09 fc ff ff       	call   2f9 <sbrk>
  if(p == (char*)-1)
 ...
 702:	e8 e9 fe ff ff       	call   5f0 <free>
  return freep;
 707:	8b 15 30 0a 00 00    	mov    0xa30,%edx

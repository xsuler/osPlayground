...
main(int argc, char *argv[])
{
  ...
  printf(1,"timepiece: %d",trace());
  11:	e8 0c 03 00 00       	call   322 <trace>
 ...
 339:	85 d2                	test   %edx,%edx
{
 ...
 367:	f7 f1                	div    %ecx
 369:	0f b6 92 40 07 00 00 	movzbl 0x740(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 584:	e9 8f fe ff ff       	jmp    418 <printf+0x48>
          s = "(null)";
 589:	bb 36 07 00 00       	mov    $0x736,%ebx
        while(*s != 0){
 ...
 5a1:	a1 e4 09 00 00       	mov    0x9e4,%eax
{
 ...
 5dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5df:	a3 e4 09 00 00       	mov    %eax,0x9e4
}
 5e4:	5b                   	pop    %ebx
 5e5:	5e                   	pop    %esi
 5e6:	5f                   	pop    %edi
 ...
 5f6:	72 ce                	jb     5c6 <free+0x26>
{
 ...
 617:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 61a:	a3 e4 09 00 00       	mov    %eax,0x9e4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 67f:	73 47                	jae    6c8 <malloc+0x98>
    ...
    if(p == freep)
 681:	39 05 e4 09 00 00    	cmp    %eax,0x9e4
 ...
 6a6:	e8 f5 fe ff ff       	call   5a0 <free>
  return freep;
 6ab:	8b 15 e4 09 00 00    	mov    0x9e4,%edx
 ...
 6e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 e4 09 00 00 e8 	movl   $0x9e8,0x9e4
 6f7:	09 00 00 
 6fa:	c7 05 e8 09 00 00 e8 	movl   $0x9e8,0x9e8
 701:	09 00 00 
    base.s.size = 0;
 704:	b8 e8 09 00 00       	mov    $0x9e8,%eax
 709:	c7 05 ec 09 00 00 00 	movl   $0x0,0x9ec
 710:	00 00 00 

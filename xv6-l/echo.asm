...
main(int argc, char *argv[])
{
  ...
  2c:	68 a2 07 00 00       	push   $0x7a2
  31:	6a 02                	push   $0x2
  33:	e8 08 04 00 00       	call   440 <printf>
  for(i = 1; i < argc; i++)
  38:	83 c4 10             	add    $0x10,%esp
  3b:	83 fe 01             	cmp    $0x1,%esi
  3e:	7e 44                	jle    84 <main+0x84>
  40:	8d 5f 04             	lea    0x4(%edi),%ebx
  43:	8d 34 b7             	lea    (%edi,%esi,4),%esi
  46:	eb 1d                	jmp    65 <main+0x65>
  48:	90                   	nop
  ...
  68:	8b 43 fc             	mov    -0x4(%ebx),%eax
  6b:	39 f3                	cmp    %esi,%ebx
  6d:	75 e1                	jne    50 <main+0x50>
  6f:	68 a0 07 00 00       	push   $0x7a0
  74:	50                   	push   %eax
  75:	68 b1 07 00 00       	push   $0x7b1
  7a:	6a 01                	push   $0x1
...
printf(int fd, char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb b6 07 00 00       	mov    $0x7b6,%ebx
        while(*s != 0){
